...
.e-lib.e-bigger .e-calendar.e-calendar-day-header-lg {
  max-width: 100%;
  min-width: 540px;
}

.e-bigger.e-calendar.e-week,
.e-lib.e-bigger .e-calendar.e-week {
  max-width: 288px;
  min-width: 288px;
}

.e-bigger.e-calendar.e-week-number,
.e-lib.e-bigger .e-calendar.e-week-number {
  min-width: 320px;
}

.e-bigger.e-calendar .e-header .e-title,
.e-lib.e-bigger .e-calendar .e-header .e-title {
  font-size: 19px;
  line-height: 48px;
  width: 60%;
}
...
.e-lib.e-bigger .e-calendar.e-rtl .e-header .e-title {
  line-height: 48px;
  text-indent: 6px;
}

.e-bigger.e-calendar .e-header,
.e-lib.e-bigger .e-calendar .e-header {
  height: 48px;
  padding: 12px 12px 0 12px;
}

.e-bigger.e-calendar .e-header span,
.e-lib.e-bigger .e-calendar .e-header span {
  font-size: 18px;
  padding: 13px;
}

.e-bigger.e-calendar .e-header.e-year, .e-bigger.e-calendar .e-header.e-decade,
.e-lib.e-bigger .e-calendar .e-header.e-year,
.e-lib.e-bigger .e-calendar .e-header.e-decade {
  padding: 12px 12px 10px 12px;
}

.e-bigger.e-calendar th,
.e-lib.e-bigger .e-calendar th {
  font-size: 15px;
  height: 37px;
}

.e-bigger.e-calendar .e-content.e-year span.e-day,
.e-lib.e-bigger .e-calendar .e-content.e-year span.e-day {
  font-size: 14px;
  font-weight: normal;
}

.e-bigger.e-calendar .e-content.e-month table,
.e-lib.e-bigger .e-calendar .e-content.e-month table {
  padding: 0 12px 12px 12px;
}

.e-bigger.e-calendar .e-content.e-year table, .e-bigger.e-calendar .e-content.e-decade table,
.e-lib.e-bigger .e-calendar .e-content.e-year table,
.e-lib.e-bigger .e-calendar .e-content.e-decade table {
  padding: 0 8.5px 3.5px 8.5px;
}

.e-bigger.e-calendar .e-content .e-selected, .e-bigger.e-calendar .e-content .e-state-hover,
.e-lib.e-bigger .e-calendar .e-content .e-selected,
.e-lib.e-bigger .e-calendar .e-content .e-state-hover {
  border-radius: 0;
}

.e-bigger.e-calendar .e-content span.e-day,
.e-lib.e-bigger .e-calendar .e-content span.e-day {
  font-size: 14px;
  height: 37px;
  line-height: 37px;
  width: 37px;
...
.e-lib.e-bigger .e-calendar .e-content.e-month td {
  height: 0;
  padding: 0;
}

.e-bigger.e-calendar .e-content.e-year td, .e-bigger.e-calendar .e-content.e-decade td,
.e-lib.e-bigger .e-calendar .e-content.e-year td,
.e-lib.e-bigger .e-calendar .e-content.e-decade td {
  height: 54px;
  padding: 0 0 13px 0;
}

.e-bigger.e-calendar .e-content.e-year td > span.e-day, .e-bigger.e-calendar .e-content.e-decade td > span.e-day,
.e-lib.e-bigger .e-calendar .e-content.e-year td > span.e-day,
.e-lib.e-bigger .e-calendar .e-content.e-decade td > span.e-day {
  height: 54px;
  line-height: 54px;
  width: 54px;
}
...
.e-lib.e-bigger .e-calendar .e-header .e-icon-container .e-prev,
.e-lib.e-bigger .e-calendar .e-header .e-icon-container .e-next {
  height: 46px;
  width: 46px;
}

.e-bigger.e-calendar .e-footer-container,
.e-lib.e-bigger .e-calendar .e-footer-container {
  border-top: none;
  padding: 0 10px 10px 10px;
}
