...
.e-treeview .e-list-item.e-editing.e-active > .e-text-content .e-list-text .e-input, .e-treeview .e-list-item.e-editing.e-hover > .e-text-content .e-list-text .e-input {
  font-weight: 600;
}
