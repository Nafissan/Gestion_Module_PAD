...
@Component({
  selector: 'fury-read-file-historique-pelerinage',
  templateUrl: './read-file-historique-pelerinage.component.html',
  styleUrls: ['./read-file-historique-pelerinage.component.scss']
})
export class ReadFileHistoriquePelerinageComponent implements OnInit {
